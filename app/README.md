...
Responsive fitness coaching pilot with trainer/trainee roles, invitations, workout assignment and logging, progress tracking, nutrition journaling, notifications, messaging, profiles, personal-data export, and test-mode subscriptions.
